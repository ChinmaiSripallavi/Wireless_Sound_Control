...
before running the code better to install all these pack
if they aren't already installed in your system.
Type all these in command prompt'''
...
cap = cv2.VideoCapture(0)#if it is inbulid camera use '0' in VideoCapture,else use 1 or default number
